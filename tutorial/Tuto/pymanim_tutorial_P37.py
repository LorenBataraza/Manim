...
class WriteExhibit(Scene): 
  def construct(self):
    eq=TextMobject("=")
    te_i=TextMobject("32,98.x + 23,32.(1-x)").shift([-3,0,0])
    te_i2=TextMobject("32,98.x + 23,32 - 23,32.x)").shift([-2.3,0,0])
    te_i3=TextMobject("32,98.x- 23,32.x").shift([-3,0,0])
    te_i4=TextMobject("(32,98 - 23,32) x").shift([-3,0,0])
    te_d=TextMobject("26,843").shift([2,0,0])
    te_d2=TextMobject("26,843 - 23,32").shift([2,0,0])

    self.add(eq)
    self.play(ReplacementTransform(te_i, te_i2))
    self.play(ReplacementTransform(te_d, te_d))
    self.wait(2)
    self.play(ReplacementTransform(te_i2, te_i3))
    self.play(ReplacementTransform(te_d, te_d2))
    self.play(ReplacementTransform(te_i3, te_i4))
class Shapes(Scene):
    #A few simple shapes
